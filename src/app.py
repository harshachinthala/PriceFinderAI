...
def create_gradio_interface():
    """Creates and returns the Gradio interface without launching it."""
    ...
    with gr.Blocks(css=custom_css, theme=gr.themes.Soft()) as demo:
        ...
        gr.Markdown('<p class="example-label" style="text-align: center; margin-top: 20px;">💡 Try these example questions:</p>')
        gr.Examples(
            examples=[
                ["Best price for iPhone 15 Pro Max"],
                ["Cheapest 4K Monitor under $500"],
                ["Where to buy Sony WH-1000XM5?"],
                ["Compare MacBook Air M3 prices"]
            ],
            inputs=user_input,
            label="",
            examples_per_page=4
